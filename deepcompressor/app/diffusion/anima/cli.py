...
def command_quantize(args: SimpleNamespace) -> int:
    ...
    recipe = {
        ...
        "low_rank_solver": "activation-aware-rrr-spectral-ridge" if args.activation_aware else "weight-svd",
        "low_rank_candidate_zero": "weight-svd" if args.activation_aware else "",
